...
import Loading from "../../components/loader/loading_page/loading";
...
const Model = (props) => {
  ...
  {
    data
      .filter((task) => task.stream.includes(currentItem))
      .map((item) => {
                  ...
                  if (values.endpoint == undefined) {
                    ...
                    if (command == true) {
                      try {
                        ...
                        const res = await api.crud.updateConfig(request, {
                          ...values,
                          currentItem,
                          seq,
                          history,
                      ...
                      try {
                        ...
                        const res = await api.crud.addconfig(request, {
                          ...values,
                          currentItem,
                          seq,
                          history,
