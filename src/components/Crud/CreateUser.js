...
export default function CreateUser() {
  ...
  useEffect(async () => {
    ...
    roles.data.data.rows.map((item) => {
      apps.push(item.role_name);
      setrole(apps);
    });
  }, [email]);
            ...
            <Form onSubmit={handleSubmit((data) => handleOnSubmit(data))}>
              <div className="col-12">
                    ...
                    <div className="col-12">
                      ...
                      <div className="d-flex align-items-center justify-content-center">
                        ...
                        <button
                          ...
                          onClick={async (e) => {
                            e.preventDefault();
                            if (validator.isEmpty(email) || emailError.error) {
                              return;
                            }
                            setLoading(true);
                            if (!validator.isEmail(watch("email").trim())) {
                              setEmailError((preValue) => ({
                                ...preValue,
                                error: true,
                                message: "Invalid Email",
                ...
                <div className="d-flex justify-content-end">
                  ...
                  <Button
                    disabled={!emailVerified || isloadingbutton}
                    type="submit"
                    variant="success"
